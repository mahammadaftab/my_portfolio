    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-black py-16">
      <div ref={containerRef} className="container mx-auto px-4 relative">
        ...
        >
          ...
          {[
            { title: "🏢 Offline Hackathons", mode: "Offline" },
            { title: "🌐 Online Hackathons", mode: "Online" }
          ].map((section, sectionIdx) => {
            const sectionHackathons = hackthons.filter(h => h.mode === section.mode);
            
            return (
              <div key={section.mode} className={sectionIdx === 0 ? "mb-16" : ""}>
                <h3 className="text-2xl font-semibold text-center text-rose-600 dark:text-rose-400 mb-8">
                  {section.title}
                </h3>
                
                {sectionHackathons.length > 0 ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {sectionHackathons.map((hackathon, index) => {
              ...
              return (
                ...
                >
                  ...
                  <p className={`mb-4 whitespace-pre-wrap ${hackathon.highlighted ? 'text-gray-700 dark:text-gray-300 font-medium' : 'text-gray-600 dark:text-gray-400'}`}>
                  ...
                  {hackathon.highlighted && hackathon.keyAchievement && (
                    <div className="mb-4 p-3 bg-gradient-to-r from-yellow-100 to-amber-100 dark:from-yellow-900/30 dark:to-amber-900/30 rounded-lg border border-yellow-300 dark:border-yellow-600">
                      <p className="text-sm font-semibold text-yellow-800 dark:text-yellow-300 flex items-center gap-2">
                        ...
                        <span>Key Achievement: {hackathon.keyAchievement}</span>
                      </p>
                    </div>
                  )}
                  ...
                  <div className="mt-auto pt-4 flex flex-wrap items-center gap-4">
                    ...
                    {hackathon.githubLink && (
                      <a 
                        ...
                        className="inline-flex items-center font-medium text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors"
                      >
                    ...
                    {hackathon.liveLink && (
                      <a 
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center font-medium text-emerald-600 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-300 transition-colors"
                      >
                  ...
                  <div className="flex flex-col items-center justify-center p-12 bg-white/50 dark:bg-gray-800/50 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 border-dashed">
                    <div className="text-4xl mb-4">💻</div>
                    <h4 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Exploring Opportunities</h4>
                    <p className="text-gray-500 dark:text-gray-400 text-center">Looking forward to participating in exciting virtual hackathons soon!</p>
                  </div>
                )}
              </div>
            );
